...
ActiveRecord::Schema[7.0].define(version: 2022_07_28_131352) do
  ...
  create_table "doc_assigns", force: :cascade do |t|
    t.integer "doctor_id"
    t.integer "specialty_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_doc_assigns_on_doctor_id"
    t.index ["specialty_id"], name: "index_doc_assigns_on_specialty_id"
  end
